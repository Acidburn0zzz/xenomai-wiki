Running applications for Xenomai 3.x
====================================
...
Linux kernel as described in link:Installing_Xenomai_3[this
document].
...
link:Installing_Xenomai_3#Generic_configuration_options_both_cores[configuration
switch]).

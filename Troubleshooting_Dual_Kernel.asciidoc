...
link:Troubleshooting_A_Single_Kernel_Configuration[troubleshooting
information here].
...
support.  See
link:Installing_Xenomai_3_X#Installing_the_Cobalt_core[this document]
...
link:Running_A_Xenomai_Application_As_A_Regular_User[this page].
...
are available from link:Installing_Xenomai_3_X[this page] for Xenomai
3, and link:Installing_Xenomai_2_X[this page] for Xenomai 2.

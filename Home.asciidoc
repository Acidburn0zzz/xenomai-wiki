...
* **Xenomai 2.6**:  git://archive.xenomai.org/xenomai-2.6.git
* **Xenomai 2.5**:  git://archive.xenomai.org/xenomai-2.5.git
* **Xenomai 2.4**:  git://archive.xenomai.org/xenomai-2.4.git
* **Xenomai 2.3**:  git://archive.xenomai.org/xenomai-2.3.git
* **Xenomai 2.2**:  git://archive.xenomai.org/xenomai-2.2.git
* **Xenomai 2.1**:  git://archive.xenomai.org/xenomai-2.1.git
* **Xenomai 2.0**:  git://archive.xenomai.org/xenomai-2.0.git